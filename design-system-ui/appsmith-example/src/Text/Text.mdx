...
![Text anatomy](./docs/Text-anatomy.png)
...
<Canvas of={ TextStories.Size1Text } />


### Size 2
<!-- A line indicating what are the specific usages of size 2 alone-->
<Canvas of={ TextStories.Size2Text } />
